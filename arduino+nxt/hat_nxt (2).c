#pragma config(Sensor, S2,     Dist,           sensorSONAR)
...
#pragma config(Motor,  motorC,          motor_c,            tmotorNXT, PIDControl, encoder)
...
task Display_data()
{
	while (true)
	{
     ...
     if (Recieve_error == false) {
        ...
        nxtDisplayTextLine(6,"No recieve byte");
     }
...
//	  motor[motor_c]=-70;
	 ...
	 while (stop_m_flag == false)
	 {
	   if ((recieve_data == 1) && (forward_flag == false))//forward
	   {
   	 	motor[motor_a]=40;
  	  motor[motor_b]=35;
  	  motor[motor_c]=-70;
	   ...
	   if ((recieve_data == 2)&& (right_flag == false))//right
	   {
	     motor[motor_a]=50;
	     motor[motor_b]=-50;
	     wait1Msec(500);
	   ...
	   if ((recieve_data == 3) && (left_flag == false))//left
	   {
	     motor[motor_a]=-50;
	     motor[motor_b]=50;
	     wait1Msec(500);
